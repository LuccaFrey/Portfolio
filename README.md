...
Mechanical engineer focused on CNC manufacturing, design for manufacturability (DFM), tooling development, and prototype aerospace hardware. This portfolio highlights selected projects spanning aerospace welding tooling, CNC manufacturing, CAM programming, shop tooling, and regeneratively cooled rocket engine machining.
...
The chamber prototype included 50 indexed regenerative cooling channels machined on a VF-2 4th axis using custom fixturing and tailstock-supported workholding to maintain rigidity during long slitting operations. Initial manufacturing was completed in aluminum before transitioning toward final copper chamber production.
...
## Manufactured Result
Final copper tip assemblies — machined, press-fit into the base, and shaped using the bending mold. These replaced the externally sourced tips at a fraction of the original cost.
